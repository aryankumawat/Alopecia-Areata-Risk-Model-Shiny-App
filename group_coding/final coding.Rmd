...
eMat_selected <- eMat[selected_genes, ]
eMat_selected <- eMat_selected[complete.cases(eMat_selected), ]  # Remove rows with NA
eMat_selected <- eMat_selected[!is.infinite(rowSums(eMat_selected)), ]  # Remove rows with infinite values
